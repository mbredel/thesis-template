...
%\newcommand{\mySubject}{Classic Thesis Styling}
%\newcommand{\myKeywords}{thesis, latex, styling}
...
\newcommand{\myLang}{en-US} % change this to your language's ISO code (de-DE, de, en-UK, etc.)
